...
function Card(props) {
  ...
  const handleAddToCart = async () => {
    ...
    // Find the food item in the data array
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className=" flex justify-center items-center ">
            <button
              className="m-3 p-1 bg-foodDetails text-customColor dark:bg-DarkFoodDetails  rounded focus:ring-1  focus:ring-orange-700 hover:bg-orange-200 "
